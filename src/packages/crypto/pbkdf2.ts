...
export async function pbkdf2Sha512Subtle(
  ...
  assert(
    ...
    "subtle.importKey is not a function"
  );
  assert(
    typeof subtle.deriveBits === "function",
    "subtle.deriveBits is not a function"
  );
...
export async function pbkdf2Sha512NodeCrypto(
  ...
  assert(
    typeof nodeCrypto === "object",
    "Argument nodeCrypto is not of type object"
  );
  assert(
    typeof nodeCrypto.pbkdf2 === "function",
    "nodeCrypto.pbkdf2 is not a function"
  );
