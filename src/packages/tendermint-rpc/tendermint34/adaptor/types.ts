...
export type Decoder<T extends responses.Response> = (
...
export interface Params {
  ...
  readonly encodeBlockchain: (
    req: requests.BlockchainRequest
  ) => JsonRpcRequest;
  readonly encodeBlockResults: (
    req: requests.BlockResultsRequest
  ) => JsonRpcRequest;
  readonly encodeBlockSearch: (
    req: requests.BlockSearchRequest
  ) => JsonRpcRequest;
  readonly encodeBroadcastTx: (
  ...
  readonly encodeNumUnconfirmedTxs: (
