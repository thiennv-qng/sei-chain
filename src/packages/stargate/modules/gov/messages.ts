...
export function isMsgDepositEncodeObject(
  ...
  return (
    (object as MsgDepositEncodeObject).typeUrl ===
...
export function isMsgSubmitProposalEncodeObject(
  ...
  return (
    (object as MsgSubmitProposalEncodeObject).typeUrl ===
...
export function isMsgVoteEncodeObject(
  object: EncodeObject
): object is MsgVoteEncodeObject {
  return (
    (object as MsgVoteEncodeObject).typeUrl === "/cosmos.gov.v1beta1.MsgVote"
  );
}
...
export function isMsgVoteWeightedEncodeObject(
  object: EncodeObject
): object is MsgVoteWeightedEncodeObject {
  return (
    (object as MsgVoteWeightedEncodeObject).typeUrl ===
