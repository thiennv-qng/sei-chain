...
import { AminoMsg, Coin, Pubkey } from "../../../amino";
import { assertDefinedAndNotNull } from "../../../utils";
import { decodePubkey, encodePubkey } from "../../../proto-signing";
    ...
    "/cosmos.staking.v1beta1.MsgEditValidator": {
      ...
      toAmino: ({
        ...
        return {
          ...
          commission_rate: commissionRate
            ? protoDecimalToJson(commissionRate)
            : undefined,
          // empty string in the protobuf document means "do not change"
          min_self_delegation: minSelfDelegation
            ? minSelfDelegation
      ...
      fromAmino: ({
        ...
        commissionRate: commission_rate
          ? jsonDecimalToProto(commission_rate)
          : "",
        // empty string in the protobuf document means "do not change"
        minSelfDelegation: min_self_delegation ?? "",
        validatorAddress: validator_address,
