...
export function isMsgBeginRedelegateEncodeObject(
  o: EncodeObject
): o is MsgBeginRedelegateEncodeObject {
  return (
    (o as MsgBeginRedelegateEncodeObject).typeUrl ===
...
export function isMsgCreateValidatorEncodeObject(
  o: EncodeObject
): o is MsgCreateValidatorEncodeObject {
  return (
    (o as MsgCreateValidatorEncodeObject).typeUrl ===
...
export function isMsgDelegateEncodeObject(
  object: EncodeObject
): object is MsgDelegateEncodeObject {
  return (
    (object as MsgDelegateEncodeObject).typeUrl ===
...
export function isMsgEditValidatorEncodeObject(
  o: EncodeObject
): o is MsgEditValidatorEncodeObject {
  return (
    (o as MsgEditValidatorEncodeObject).typeUrl ===
...
export function isMsgUndelegateEncodeObject(
  object: EncodeObject
): object is MsgUndelegateEncodeObject {
  return (
    (object as MsgUndelegateEncodeObject).typeUrl ===
