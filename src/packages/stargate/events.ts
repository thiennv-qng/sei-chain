...
import { tendermint34, tendermint37 } from "../tendermint-rpc";
 ...
 */
export function fromTendermintEvent(
  event: tendermint34.Event | tendermint37.Event
): Event {
  return {
    type: event.type,
